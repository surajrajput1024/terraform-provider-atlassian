...
Import by permission scheme ID. The resource block must exist in config before importing.

```bash
terraform import atlassian_jira_permission_scheme.scheme 10000
```

**Import ID:** the permission scheme ID (e.g. `10000`). See [Importing resources](../import.md) for more.
