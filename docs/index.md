...
**Importing existing resources:** Use [terraform import](https://developer.hashicorp.com/terraform/cli/import) to bring existing Jira projects, permission schemes, groups, etc. into Terraform state. See [Importing resources](import.md) for import ID formats and examples for each resource.
